    ...
    <>
      ...
      <section className="relative h-72 flex items-center justify-center bg-charcoal overflow-hidden">
        <div className="absolute inset-0">
          <Image src="https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?q=80&w=1920&auto=format&fit=crop" alt="About Us" fill className="object-cover opacity-30" />
        </div>
      ...
      <section ref={storyRef} className="py-20 lg:py-28 bg-cream dark:bg-charcoal transition-colors duration-500">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className={`grid grid-cols-1 lg:grid-cols-2 gap-16 items-center ${storyInView ? "animate-fade-in-up" : "opacity-0"}`}>
            <div className="relative h-72 sm:h-96 lg:h-[500px] rounded-2xl overflow-hidden shadow-2xl group">
              <Image src="https://images.unsplash.com/photo-1552566626-52f8b828add9?q=80&w=1200&auto=format&fit=crop" alt="Restaurant Interior" fill className="object-cover group-hover:scale-105 transition-transform duration-700" />
