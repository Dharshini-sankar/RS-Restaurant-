        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <p className="text-white/60 text-sm leading-relaxed">
              Experience the finest dining with our expertly crafted dishes,
              warm ambiance, and exceptional service that makes every visit
              memorable.
            </p>
          </div>
          ...
          {/* Quick Links */}
          <div>
            <h3 className="text-gold font-heading text-lg font-semibold mb-6">
              Quick Links
            </h3>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-white/60">
              <li className="flex items-start gap-3">
                ...
                <span>123 Food Street, Downtown Business District, Chennai, Tamil Nadu</span>
              </li>
              ...
              <li className="flex items-center gap-3">
                ...
                <span>info@rsrestaurant.com</span>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-white/60">
              ...
              <li className="flex justify-between">
                <span>Saturday</span>
                <span className="text-white/80">10:00 AM - 12:00 AM</span>
              </li>
              <li className="flex justify-between">
                <span>Sunday</span>
                <span className="text-white/80">10:00 AM - 11:00 PM</span>
              </li>
            </ul>
            <div className="flex gap-3 mt-6">
              {socialLinks.map((s) => (
                <a
                  ...
                  href={s.href}
                  aria-label={s.label}
                  className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center text-white/60 hover:bg-gold hover:text-charcoal transition-all duration-300"
                >
                  {s.icon}
                </a>
              ))}
